...
// MFC_DeltaFinal.cpp : 定義應用程式的類別行為。
//
...
BEGIN_MESSAGE_MAP(CMFC_DeltaFinalApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFC_DeltaFinalApp 建構

CMFC_DeltaFinalApp::CMFC_DeltaFinalApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_DeltaFinalApp 物件

CMFC_DeltaFinalApp theApp;


// CMFC_DeltaFinalApp 初始設定

BOOL CMFC_DeltaFinalApp::InitInstance()
{
